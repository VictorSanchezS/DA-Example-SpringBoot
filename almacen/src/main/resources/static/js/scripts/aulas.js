    ...
    $.ajax({
        ...
        success: function (data) {
			if(data==0){
				Swal.fire({
	                icon: 'error',
	                title: 'La aula ya esta registrada',
...
$(document).ready(function () {
    ...
    $(document).on('click', '.eliminar', function () {
        Swal.fire({
            title: 'Eliminar Aula',
            text: "¿Esta seguro de querer eliminar este aula?",
            icon: 'warning',
